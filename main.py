...
async def twilio_process(request: Request):
    ...
    try:
        reply = client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
                {"role": "system", "content": "You are an AI interviewer your job is identify if candidate is fit for Python developer make sure to ask candidate his name current CTC and notice period."},
